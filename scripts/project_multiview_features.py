...
# SCANNET_DATA = "./data/scannet/scannet_data_full/"
...
def get_scene_data(scene_list):
    ...
    for scene_id in scene_list:
        ...
        try:
            ...
            print("failed to load {}".format(scene_id))
            continue
...
if __name__ == "__main__":
    ...
    os.makedirs(ENET_FEATURE_DATABASE, exist_ok=True)
    ...
    for scene_id in tqdm(scene_list):
        ...
        # save
        enet_feats_file = os.path.join(ENET_FEATURE_DATABASE, scene_id) + '.pkl'
        pickle.dump(np.array(point_features.cpu().numpy()), open(enet_feats_file, 'wb'))
