...
class BLIP_VQA_Selector(nn.Module):
    def __init__(
        self,
        ...
        sel_config.num_hidden_layers = 1
        self.selector = BertEncoder(sel_config)
        self.selector_pooler = BertPooler(sel_config)
    ...
    def forward(
        ...
        if train:
            ...
            selector_output = self.selector_head(
...
def blip_vqa(pretrained="", **kwargs):
    model = BLIP_VQA_Selector(**kwargs)
    if pretrained:
